                            ...
                            <div className="flex flex-col w-full md:w-1/4 mb-4 md:mb-0"
                                ...
                                <div className="flex flex-col mt-4 space-y-5 flex-1 justify-start">
                                    ...
                                    <Link to="/profile" style={{ textDecoration: 'none' }}>
                                        <Button startIcon={<PersonIcon />} sx={{ backgroundColor: "#f6f8fb", color: "#4F4F4F", fontFamily: 'Lato, sans-serif', borderRadius: '10px', justifyContent: 'flex-start', padding: '8px 20px', color: location.pathname === '/profile-settings' ? '#0eabeb' : '#4F4F4F', }} className="w-full text-gray1 p-3">
                                            Profile
                                        </Button>
                                    </Link>
