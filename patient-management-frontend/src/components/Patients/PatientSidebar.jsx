...
const PatientSidebar = () => {
    ...
    return (
        <div className="w-72 bg-white h-full shadow-lg flex flex-col justify-between">
            ...
            {/* Menu Items */}
            <div className="border-gray-200 mx-5"></div>
            <ul className="mt-1 flex-grow">
                {menuItems.map((item) => (
                    <li className="py-1" key={item.label}>
                        <NavLink
                            to={item.path}
            ...
            <div className="relative px-5 m-5 bg-gray-100 rounded-2xl">
                <div className="flex justify-center mb-4 relative z-10">
                    <img
                        src={elements_1} // Correct image reference
                        alt="elements_1"
                        className="w-48 h-48 -mt-32" // Tailwind classes
                    />
                </div>
