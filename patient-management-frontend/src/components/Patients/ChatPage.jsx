                            ...
                            {filteredChatList.length > 0 ? (
                                filteredChatList.map((chat) => (
                                    <div
                                        ...
                                        className={`flex items-center p-2 cursor-pointer ${selectedChat?.id === chat.id ? "bg-blue-100" : ""
                                            }`}
                                    >
                                        <img
                                            src={Profile_2}
                            ...
                            <>
                                ...
                                <div className="flex-1 space-y-4 overflow-y-auto bg-gray-50 p-4 rounded-lg shadow-inner">
                                    {messages.map((message, index) => (
                                        ...
                                        >
                                            <div
                                                className={`p-2 rounded-lg ${message.sender === "You" ? "bg-blue-100" : "bg-gray-200"
                                                    }`}
                                            >
                                                <p>{message.content}</p>
