                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col md:flex-row">
                            ...
                            <div className="flex flex-col w-full md:w-1/5 mb-4 md:mb-0"
                                ...
                                <div className="flex flex-col mt-4 space-y-5 flex-1 justify-start">
                                    ...
                                    <NavLink to="/doctorprofile" style={{ textDecoration: 'none' }}>
                                        <Button startIcon={<DoctorIcon />} sx={{ fontWeight: '600', backgroundColor: "#f6f8fb", color: "#4F4F4F", fontFamily: 'Lato, sans-serif', borderRadius: '10px', justifyContent: 'flex-start', padding: '8px 20px', color: location.pathname === '/doctorprofile' ? '#0eabeb' : '#4F4F4F', }} className='w-full text-gray1 font-lato p-3'>
                                            Profile
                                        </Button>
                                    </NavLink>
                                    <NavLink to="/doctorchangepsd" style={{ textDecoration: 'none' }}>
                                        <Button startIcon={<EnhancedEncryptionIcon />} sx={{ fontWeight: '600', backgroundColor: "#f6f8fb", color: "#4F4F4F", fontFamily: 'Lato, sans-serif', borderRadius: '10px', justifyContent: 'flex-start', padding: '8px 20px', color: location.pathname === '/doctorchangepsd' ? '#0eabeb' : '#4F4F4F', }} className="w-full text-gray1">
                                            Change Password
                                        </Button>
                                    </NavLink>
                                    <NavLink to="/doctorterms" style={{ textDecoration: 'none' }}>
                                        <Button startIcon={<TermsIcon />} sx={{ fontWeight: '600', backgroundColor: "#f6f8fb", color: "#4F4F4F", fontFamily: 'Lato, sans-serif', borderRadius: '10px', justifyContent: 'flex-start', padding: '8px 20px', color: location.pathname === '/doctorterms' ? '#0eabeb' : '#4F4F4F', }} className="w-full text-gray1">
                                            Terms & Conditions
                                        </Button>
                                    </NavLink>
                                    <NavLink to="/doctorprivacy" style={{ textDecoration: 'none' }}>
                                        <Button startIcon={<PrivacyIcon />} sx={{ fontWeight: '600', backgroundColor: "#f6f8fb", color: "#4F4F4F", fontFamily: 'Lato, sans-serif', borderRadius: '10px', justifyContent: 'flex-start', padding: '8px 20px', color: location.pathname === '/doctorprivacy' ? '#0eabeb' : '#4F4F4F', }} className="w-full text-gray1">
                                            Privacy Policy
                                        </Button>
                                    </NavLink>
                                </div>
