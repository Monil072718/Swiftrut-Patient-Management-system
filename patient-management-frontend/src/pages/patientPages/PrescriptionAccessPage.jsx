            ...
            <div className="flex-1 flex flex-col">
                ...
                <div className="bg-white p-6 rounded-lg shadow-lg m-6 h-full">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <button className="bg-sky-500 text-white px-4 py-2 rounded flex items-center space-x-2">
                            <FaCalendarAlt />
                        ...
                        {prescriptions.map((prescription, index) => (
                            ...
                            >
                                ...
                                <div className="flex justify-between items-center px-4 py-2 bg-gray-50 rounded-t-lg">
                                    ...
                                    <div className="flex">
                                        <div className="text-sky-500 text-lg cursor-pointer rounded-lg bg-white p-2">
                                            <FaDownload onClick={() => openModal(prescription)} />
                                        </div>
                                        <div className="text-sky-500 text-lg cursor-pointer rounded-lg bg-white p-2 mr-2">
                                ...
                                <div className="flex items-center border-2 m-4 rounded-lg p-2">
                                    <div className="text-sky-500 rounded-lg p-4 text-3xl bg-gray-50">
                                        <FaImage />
                                    </div>
                                    <div className="ml-2">
