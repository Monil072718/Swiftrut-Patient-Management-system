              ...
              <div className=" w-custom-79">
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div className="flex flex-col relative mb-4">
                    <label className="absolute left-3 -top-2.5 px-1 bg-white text-sm font-medium text-gray-500 transition-all duration-200 peer-focus:-top-2.5 peer-focus:left-3 ">Doctor Name</label>
                    <input type="text" className="peer w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-0" placeholder="Enter Doctor Name" />
                  </div>
                  <div className="flex flex-col relative">
                    <label className="absolute left-3 -top-2.5 px-1 bg-white text-sm font-medium text-gray-500 transition-all duration-200 peer-focus:-top-2.5 peer-focus:left-3 ">Doctor Qualification</label>
                    <input type="text" className="peer w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-0" placeholder="Enter Doctor Qualification" />
                  </div>
                  {/* Row 2 */}
                  <div className="flex flex-col relative">
                    <label className="absolute left-3 -top-2.5 px-1 bg-white text-sm font-medium text-gray-500 transition-all duration-200 peer-focus:-top-2.5 peer-focus:left-3 ">Specialty Type</label>
                    <input type="text" className="peer w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-0" placeholder="Enter Specialty Type" />
                  </div>
                  <div className="flex flex-col relative mb-4">
